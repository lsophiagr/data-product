...
st.markdown(
    """
    ### Learning Streamlit, see the code on my github [here](https://github.com/lsophiagr/Data-Product/blob/master/streamlit/first_app.py)
    """
)
...
st.markdown(
    """
    ## Exercise Uber Pickups [here](https://github.com/lsophiagr/Data-Product/blob/master/streamlit/uber_pickups.py)
    """
)
